...
if (args.help) {
    ...
    console.log('Shifter for applications (experimental):');
    console.log('   --freestyle                      Build modules without requiring build.js, just the raw yui module with .js extension');
    console.log('   --include-dirs=foo,./bar         When running a walk, filter the folders to be analyzed');
    console.log('   --exclude-dirs=node_modules/yui  When running a walk, exclude specific folders');
