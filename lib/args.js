...
var setDefaults = function(parsed) {
    ...
    parsed['dynamic-skins'] = (parsed['dynamic-skins'] === undefined || parsed['dynamic-skins'] === false) ? false : true;

    //Other defaults
    parsed['build-dir'] = parsed['build-dir'] || '../../build';

    if (parsed['global-skins-dir']) {
        parsed['global-skins-dir'] = require('path').resolve(parsed['global-skins-dir']);
    }
