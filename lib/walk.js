...
exports.run = function (options) {
    ...
    var modStack = new Stack(),
        ...
        bar = new ProgressBar(log.color('  shifting [', 'magenta') + log.color(':bar', 'cyan') + log.color(']', 'magenta') + log.color(' :percent :etas', 'yellow'), { total: 100, width: 100, complete: '>', incomplete: ' ' }),
        i,
        args = [];
